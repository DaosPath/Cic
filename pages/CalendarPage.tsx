                    ...
                    <div className="bg-brand-surface border border-brand-border rounded-xl shadow-2xl p-3 min-w-[200px] text-left backdrop-blur-lg">
                        ...
                        {log.periodIntensity && log.periodIntensity > 0 && (
                            <div className="text-xs text-brand-text mb-1.5 flex items-center gap-1.5">
                                <span className="text-phase-menstruation">❤️</span>
                                <span>{t('menstruationIntensity')}: {log.periodIntensity}/3</span>
                            </div>
                        )}
                        {log.mood && (
                            <div className="text-xs text-brand-text mb-1.5 flex items-center gap-1.5">
                        ...
                        {log.symptoms && log.symptoms.length > 0 && (
                            <div className="text-xs text-brand-text mb-1.5 flex items-center gap-1.5">
                                ...
                                <span>{log.symptoms.length} {t('symptoms')}</span>
                            </div>
                        )}
                        {log.notes && (
                            ...
                            <div className="bg-brand-surface-2 p-3 rounded-xl border border-brand-border">
                                ...
                                <div className="space-y-1.5 text-xs">
                                    ...
                                    {hasData('sexualActivity') && (
                                        <div className="flex justify-between">
                                            <span className="text-brand-text-dim">{t('sexualActivityLabel')}:</span>
                                            <span className="text-brand-text font-medium">
                                                {log.sexualActivity ? 'S?' : 'No'}
                                                {log.sexualActivity && log.protection !== undefined && 
                                                 ` (${log.protection ? 'con protecci?n' : 'sin protecci?n'})`}
                                            </span>
                                        </div>
                                    )}
                                </div>
