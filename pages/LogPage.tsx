        ...
        <div className="min-h-screen px-4 md:px-8 pt-12 pb-24 md:pb-12">
            ...
            {isAdvancedMode && (
                ...
                >
                    ...
                    {/* Chat CTA */}
                    <div className="mt-6 bg-gradient-to-br from-brand-primary/10 via-brand-accent/10 to-brand-primary/10 border border-brand-primary/30 rounded-[18px] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.15)] hover:shadow-[0_6px_24px_rgba(0,0,0,0.25)] transition-all duration-300">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-brand-text-dim" style={{ fontWeight: 500, lineHeight: 1.45 }}>
                                        Analiza tu registro de hoy y obtén recomendaciones personalizadas
                                    </p>
                                </div>
                            </div>
                            
                            <button
                                onClick={() => {/* TODO: Implement chat with today's log context */}}
                        ...
                        <div className="mt-4 pt-4 border-t border-brand-border/50 flex items-center gap-2 text-xs text-brand-text-dim">
                            ...
                            <span style={{ fontWeight: 500 }}>
                                Contexto: <span className="text-brand-primary font-semibold">Registro de {formattedDate}</span>
                            </span>
                        </div>
                    </div>
                </div>
