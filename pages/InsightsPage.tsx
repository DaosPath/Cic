    ...
    return (
        <div className="bg-gradient-to-br from-brand-surface/70 to-brand-surface/50 p-6 rounded-3xl backdrop-blur-lg border border-brand-primary/20 shadow-xl">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h2 className="text-xl font-bold text-brand-text tracking-wide">Duración del Ciclo</h2>
                    <p className="text-sm text-brand-text-dim">Promedio: {avgLen} días</p>
                </div>
            </div>
            <div className="bg-brand-surface/30 p-4 rounded-2xl">
                <svg viewBox={`0 0 ${chartWidth} ${chartHeight}`} className="w-full" aria-label="Gráfico de duración de los últimos ciclos">
                    ...
                    {chartData.map((len, index) => {
                        ...
                        const barHeight = Math.max(15, heightRatio * (chartHeight - 40) + 20);
                        ...
                        return (
                            <g key={index}>
                                ...
                                <text
                                    ...
                                    textAnchor="middle"
                                    fontSize="12"
                                    className="fill-current text-brand-text font-bold"
                                >
                                    {len}d
                                </text>
                            </g>
        ...
        return (
            <div className="min-h-screen p-4 md:p-8 pt-12 max-w-2xl mx-auto">
                <div className="bg-gradient-to-br from-brand-surface/70 to-brand-surface/50 p-12 rounded-3xl backdrop-blur-lg border border-brand-primary/20 shadow-xl text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 text-brand-text tracking-tight">Análisis de Ciclos</h1>
                    <p className="text-lg text-brand-text-dim leading-relaxed">
                        No hay suficientes datos para mostrar un análisis detallado.<br />
        ...
        <div className="min-h-screen p-4 md:p-8 pt-12 max-w-7xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-brand-surface/70 to-brand-surface/50 p-8 rounded-3xl backdrop-blur-lg border border-brand-primary/20 shadow-xl mb-8">
                <div className="text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-3 text-brand-text tracking-tight">Análisis de Ciclos</h1>
                    <p className="text-lg md:text-xl text-brand-text-dim font-light">
                        Descubre patrones en tu salud menstrual
                    </p>
            ...
            <div className="mb-8">
                <div className="bg-gradient-to-br from-brand-surface/70 to-brand-surface/50 p-6 rounded-3xl backdrop-blur-lg border border-brand-primary/20 shadow-xl">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-brand-text tracking-wide">Síntomas Favoritos</h2>
                    </div>
                    {favoriteSymptoms.length > 0 ? (
                        ...
                        <div className="text-center py-8">
                            <p className="text-brand-text-dim">Marca tus síntomas más importantes con una estrella para verlos aquí.</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-brand-surface/70 to-brand-surface/50 p-6 rounded-3xl backdrop-blur-lg border border-brand-primary/20 shadow-xl">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-xl font-bold text-brand-text tracking-wide">Historial de Ciclos</h2>
                        </div>
                                ...
                                <div key={cycle.id} className="bg-brand-surface/30 p-4 rounded-2xl border border-brand-primary/10 hover:border-brand-primary/20 transition-colors">
                                    <div className="flex justify-between items-center mb-2">
                                        <h3 className="text-lg font-bold text-brand-text">
                                            {index === 0 ? "Ciclo Actual" : `Ciclo ${cycles.length - index}`}
                                        </h3>
                                        {cycle.length && (
                ...
                <div className="bg-gradient-to-br from-brand-surface/70 to-brand-surface/50 p-6 rounded-3xl backdrop-blur-lg border border-brand-primary/20 shadow-xl flex flex-col lg:h-[700px]">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-brand-text tracking-wide">Análisis de Síntomas</h2>
                    </div>
